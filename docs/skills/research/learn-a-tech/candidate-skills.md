...
## Candidats devenus de vrais skills

- **saltbox/create-custom-role**, créé le 2026-09-23 après validation explicite de l'utilisateur, cf. `skills/saltbox/create-custom-role/SKILL.md`.
